...
const WhyChooseUs = () => {
    ...
    return (
        <div className=' flex flex-col justify-center items-center my-6' >
          ...
          <div className='flex  flex-col border-2 border-[#b057a3] rounded-xl px-10 py-5'>
                    <div className='flex justify-center items-center  mr-6'>
                        <h1 className='flex justify-center items-center  text-xl font-bold text-white box-border mx-auto w-[50px] h-[50px] bg-[#b057a3] rounded-full'>01</h1>
                        </div>
                    <div className='flex flex-col justify-center  text-center'>
                        <div className="heading  my-3 text-2xl font-bold text-[#b057a3]"><h1>Expertise in Every Pixel</h1></div>
                ...
                <div className='flex  flex-col border-2 border-[#b057a3] rounded-xl px-10 py-5'>
                    <div className='flex justify-center items-center  mr-6'>
                        <h1 className='flex justify-center items-center  text-xl font-bold text-white box-border mx-auto w-[50px] h-[50px] bg-[#b057a3] rounded-full'>02</h1>
                        </div>
                    <div className='flex flex-col justify-center  text-center'>
                        <div className="heading  my-3 text-2xl font-bold text-[#b057a3]"><h1>Innovation That Speaks Volumes</h1></div>
                ...
                <div className='flex  flex-col border-2 border-[#b057a3] rounded-xl px-10 py-5'>
                    <div className='flex justify-center items-center  mr-6'>
                        <h1 className='flex justify-center items-center  text-xl font-bold text-white box-border mx-auto w-[50px] h-[50px] bg-[#b057a3] rounded-full'>03</h1>
                        </div>
                    <div className='flex flex-col justify-center  text-center'>
                        <div className="heading  my-3 text-2xl font-bold text-[#b057a3]"><h1>Comprehensive Digital Ecosystem</h1></div>
