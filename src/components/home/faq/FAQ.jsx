...
const FAQ = () => {
	...
	<div className="container flex flex-col justify-center px-4 py-8 mx-auto md:p-8">
		<h2 className=" w-full text-3xl text-[#5F9FFF] uppercase py-4 font-serif font-semibold">Frequently Asked Questions</h2>
		<p className=" w-full mt-4 mb-8 dark:text-gray-400">Get Answers to Common Queries About Our Employee Management System</p>
		<div className="space-y-4">
			...
			<details className="w-full border rounded-lg">
				<summary className=" text-lg px-4 py-6 font-semibold focus:outline-none ">How does the system handle salary payments and payroll processing?</summary>
			...
			<details className="w-full border rounded-lg">
				<summary className="text-lg px-4 py-6 font-semibold focus:outline-none "> How secure is the employee data stored within the system?</summary>
